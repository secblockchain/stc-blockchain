...
func (p *Stcons) getTurnLength(chain consensus.ChainHeaderReader, header *types.Header) (*uint8, error) {
...
func (p *Stcons) getTurnLengthFromContract(header *types.Header) (turnLength *big.Int, err error) {
...
func (p *Stcons) getRandTurnLength(header *types.Header) (turnLength *big.Int, err error) {
