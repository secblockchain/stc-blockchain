...
func (p *Stcons) GetValidators(offset, limit *big.Int) ([]common.Address, []common.Address, *big.Int, error) {
...
func (p *Stcons) getNodeIDsForValidators(validatorsToQuery []common.Address) (map[common.Address][]enode.ID, error) {
...
func (p *Stcons) GetNodeIDs() ([]enode.ID, error) {
...
func (p *Stcons) AddNodeIDs(nodeIDs []enode.ID, nonce uint64) (*types.Transaction, error) {
...
func (p *Stcons) GetNodeIDsMap() (map[common.Address][]enode.ID, error) {
	// Call GetValidators with latest block number
	operatorAddrs, _, _, err := p.GetValidators(big.NewInt(0), big.NewInt(1000))
	if err != nil {
		log.Error("Failed to get validators", "error", err)
...
func (p *Stcons) RemoveNodeIDs(nodeIDs []enode.ID, nonce uint64) (*types.Transaction, error) {
