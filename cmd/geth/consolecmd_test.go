...
const (
	ipcAPIs  = "admin:1.0 debug:1.0 eth:1.0 mev:1.0 miner:1.0 net:1.0 stcons:1.0 rpc:1.0 txpool:1.0 web3:1.0"
...
func runMinimalGeth(t *testing.T, args ...string) *testgeth {
	...
	allArgs := []string{"--testnet", "--networkid", "19517", "--syncmode=full", "--port", "0",
