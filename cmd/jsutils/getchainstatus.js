...
function printUsage() {
    ...
    console.log("  GetFaucetStatus: get faucet status of STC testnet");
    ...
    console.log("\nExample:");
    console.log("  node getchainstatus.js GetMaxTxCountInBlockRange --rpc https://testnet-rpc.stcexplorer.io --startNum 40000001  --endNum 40000005");
    console.log("  node getchainstatus.js GetBinaryVersion --rpc https://testnet-rpc.stcexplorer.io --num 21 --turnLength 8");
    console.log("  node getchainstatus.js GetTopAddr --rpc https://testnet-rpc.stcexplorer.io --startNum 40000001  --endNum 40000010 --topNum 10");
    console.log("  node getchainstatus.js GetSlashCount --rpc https://testnet-rpc.stcexplorer.io --blockNum 40000001 --stepNum 1 --stepLength 115200"); // default: latest block
    console.log("  node getchainstatus.js GetPerformanceData --rpc https://testnet-rpc.stcexplorer.io --startNum 40000001  --endNum 40000010");
    console.log("  node getchainstatus.js GetBlobTxs --rpc https://testnet-rpc.stcexplorer.io --startNum 40000001  --endNum 40000010");
    console.log("  node getchainstatus.js GetFaucetStatus --rpc https://testnet-rpc.stcexplorer.io --startNum 40000001  --endNum 40000010");
    console.log("  node getchainstatus.js GetKeyParameters --rpc https://testnet-rpc.stcexplorer.io"); // default: latest block
    console.log("  node getchainstatus.js GetEip7623 --rpc https://testnet-rpc.stcexplorer.io --startNum 40000001  --endNum 40000010");
    console.log("  node getchainstatus.js GetMevStatus --rpc https://testnet-rpc.stcexplorer.io --startNum 40000001  --endNum 40000010");
    console.log("  node getchainstatus.js GetLargeTxs --rpc https://testnet-rpc.stcexplorer.io --startNum 40000001  --num 100 --gasUsedThreshold 5000000");
}
...
// https://github.com/secblockchain/stc-genesis-contract/blob/master/contracts/StakeHub.sol
const stakeHubAbi = [
    ...
    "function minSelfDelegationSEP() public view returns (uint256)", // default 2000, valid: 1000 -> 100,000
    ...
    "function downtimeSlashAmount() public view returns (uint256)", // default 10 SEP, valid: 5 -> felonySlashAmount
    "function felonySlashAmount() public view returns (uint256)", // default 200 SEP, valid: > max(100, downtimeSlashAmount)
...
async function getBlockMevInfo(blockNumber) {
    ...
    try {
        ...
        // legacy payment-tx heuristic below.
    }
...
// node getchainstatus.js GetMaxTxCountInBlockRange --rpc https://testnet-rpc.stcexplorer.io \
...
async function getPerformanceData() {
    ...
    let stconsEnabled = true;
    
    try {
        turnLength = await provider.send("stcons_getTurnLength", [ethers.toQuantity(program.startNum)]);
    } catch (error) {
        // the "stcons" module was not enabled for RPC call
        stconsEnabled = false;
        console.log("stcons RPC module is not enabled\n", error);
    }
    ...
    for (let i = program.startNum; i < program.endNum; i++) {
        ...
        if (stconsEnabled) {
            let justifiedNumber = await provider.send("stcons_getJustifiedNumber", [ethers.toQuantity(i)]);
...
// STC testnet enabled 4844 on block: 39539137
...
async function getKeyParameters() {
    ...
    // part 3: staking
    // let minSelfDelegationSEP = await stakeHub.minSelfDelegationSEP({blockTag:blockNum})/BigInt(10**18)
...
// node getchainstatus.js GetMevStatus --rpc https://testnet-rpc.stcexplorer.io
//
// # Analyze specific range
// node getchainstatus.js GetMevStatus --rpc https://testnet-rpc.stcexplorer.io --startNum 40000001 --endNum 40000005
//
// # Analyze from specific block to latest
// node getchainstatus.js GetMevStatus --rpc https://testnet-rpc.stcexplorer.io --startNum 40000001
