...
var (
	...
	// Deprecated: non-consensus BAL is superseded by EIP-7928 in upstream go-ethereum.
	EnableBALFlag = &cli.BoolFlag{
		Name:     "enable-bal",
		Hidden:   true,
		Usage:    "Deprecated: block access list has been removed; this flag has no effect",
		Category: flags.DeprecatedCategory,
	}
