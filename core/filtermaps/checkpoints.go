...
//go:embed checkpoints_stc_testnet.json
var checkpointsSTCTestnetJSON []byte

//go:embed checkpoints_stc_mainnet.json
var checkpointsSTCMainnetJSON []byte
...
var checkpoints = []checkpointList{
	...
	decodeCheckpoints(checkpointsSTCTestnetJSON),
	decodeCheckpoints(checkpointsSTCMainnetJSON),
}
