...
type BlobTxSidecar struct {
	// NOTE(STC): PeerDAS support (EIP-7594) is disabled.
...
func (btx *blobTxWithBlobsV1) assign(sc *BlobTxSidecar) error {
	// NOTE(STC): Upstream geth supports both Version 0 and 1 sidecars.
	// STC only supports Version 0, as EIP-7594 (cell proofs) is not enabled yet.
