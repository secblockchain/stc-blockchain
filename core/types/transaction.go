...
// EffectiveGasPriceForSTC returns the effective gas price of the transaction on STC.
// STC does not enforce a base fee, so baseFee is always zero.
func (tx *Transaction) EffectiveGasPriceForSTC() *big.Int {
	dst := new(big.Int)
