...
//
// Block-source tagging for MEV attribution. Validators encode the winning MEV path and
...
const (
	...
	// BlockMevInfoVersionBidBlock identifies blocks produced via SendBidBlock.
