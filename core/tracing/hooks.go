...
type (
	...
	*/
	...
	// OnSystemTxStartHook is called when a system transaction is about to be executed within the Stcons consensus
	...
	// OnSystemTxEnd is called when a system transaction is about to completed its execution within the Stcons consensus
...
const (
	...
	// STC specific balance changes

	// BalanceDecreaseSTCDistributeReward is a balance change that decreases system address' balance and happens
	// when STC is distributing rewards to validator.
	BalanceDecreaseSTCDistributeReward BalanceChangeReason = 210
	// BalanceIncreaseSTCDistributeReward is a balance change that increases the block validator's balance and
	// happens when STC is distributing rewards to validator.
	BalanceIncreaseSTCDistributeReward BalanceChangeReason = 211
)
