...
func _() {
	...
	_ = x[BalanceDecreaseSTCDistributeReward-210]
	_ = x[BalanceIncreaseSTCDistributeReward-211]
}
...
const (
	...
	_BalanceChangeReason_name_1 = "BalanceDecreaseSTCDistributeRewardBalanceIncreaseSTCDistributeReward"
)
