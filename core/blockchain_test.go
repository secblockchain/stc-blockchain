...
// TestEIP2718TransitionWithStconsConfig tests EIP-2718 with Stcons Config.
func TestEIP2718TransitionWithStconsConfig(t *testing.T) {
...
func (c *mockStcons) VerifyRequests(header *types.Header, Requests [][]byte) error {
	return nil
}
...
func TestStconsBlobFeeReward(t *testing.T) {
