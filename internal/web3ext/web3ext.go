...
web3._extend({
	...
	methods: [
		new web3._extend.Method({
			name: 'getSnapshot',
			call: 'stcons_getSnapshot',
			params: 1,
			inputFormatter: [web3._extend.formatters.inputBlockNumberFormatter]
		}),
		new web3._extend.Method({
			name: 'getSnapshotAtHash',
			call: 'stcons_getSnapshotAtHash',
			params: 1
		}),
		new web3._extend.Method({
			name: 'getValidators',
			call: 'stcons_getValidators',
			params: 1,
			inputFormatter: [web3._extend.formatters.inputBlockNumberFormatter]
		}),
		new web3._extend.Method({
			name: 'getValidatorsAtHash',
			call: 'stcons_getValidatorsAtHash',
			params: 1
		}),
		new web3._extend.Method({
			name: 'getJustifiedNumber',
			call: 'stcons_getJustifiedNumber',
			params: 1,
			inputFormatter: [web3._extend.formatters.inputBlockNumberFormatter]
		}),
		new web3._extend.Method({
			name: 'getFinalizedNumber',
			call: 'stcons_getFinalizedNumber',
			params: 1,
			inputFormatter: [web3._extend.formatters.inputBlockNumberFormatter]
		}),
	],
