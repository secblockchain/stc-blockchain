...
// Version "v1" means legacy SendBid; version "v2" means SendBidBlock.
...
func (api *BlockChainAPI) getFinalizedNumber(ctx context.Context, verifiedValidatorNum int64) (int64, error) {
	stconsConfig := api.b.ChainConfig().Stcons
	if stconsConfig == nil {
		return 0, fmt.Errorf("only stcons engine supported")
	}
...
func (api *TransactionAPI) currentBlobSidecarVersion() byte {
	...
	if api.b.ChainConfig().IsOsaka(h.Number, h.Time) && api.b.ChainConfig().IsNotInSTC() {
