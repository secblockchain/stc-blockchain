...
const (
	...
	SystemTxsGasHardLimit uint64 = 20000000 // Maximum gas reserved for system transactions (Stcons consensus only)
	SystemTxsGasSoftLimit uint64 = 1000000  // Maximum gas reserved for system transactions, excluding validator update transactions (Stcons consensus only)
	...
	BlobEligibleBlockInterval          = 5       // Blob transactions are only allowed in blocks where N % 5 == 0
