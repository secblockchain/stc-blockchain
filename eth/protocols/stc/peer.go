...
// Peer is a collection of relevant information we have about a `stc` peer.
type Peer struct {
	...
	*p2p.Peer                   // The embedded P2P package peer
	rw        p2p.MsgReadWriter // Input/output streams for stc
...
// Version retrieves the peer's negotiated `stc` protocol version.
